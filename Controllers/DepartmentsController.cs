...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
                ...
                catch (DbUpdateConcurrencyException ex) 
                {
                    ...
                    else 
                    {
                        ...
                        if ( databaseValues.InstructorID != clientValues.InstructorID)
                        {
                            ...
                            ModelState.AddModelError("InstructorID", $"Current Values: {databaseValues.InstructorID}");
                        }
                        ModelState.AddModelError(string.Empty, "The record that you have attempted to edit"
                            ...
                            + "have been displayed. If you still requier to edit this record. click"
        ...
        public async Task<IActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            if (concurrencyError.GetValueOrDefault()) 
            {
                ViewData["ConcurrencyErrorMessage"] = "The record you attempted to delete"
                    ...
                    + "database have been displayed. If you still requier to edit this record. "
                    + "click the delete button again. Otherwise click the back to lsit hyperlink.";
            }
            return View(department);
        }
        //delete post
        ...
        public async Task<IActionResult> Delete(Department department)
        {
            ...
            {
                return RedirectToAction(nameof(Delete), new { concurrecyError = true, id = department.DepartmentID });
            }
            return RedirectToAction(nameof(Index));
        }
    }
